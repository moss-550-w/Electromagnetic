...
- ✅ **M0 地基**:Astro 5 + React island + Tailwind v3 + 设计令牌(tailwind.config)+ Inter self-host + KaTeX 构建时组件;原型已清理
- ✅ **首页**:开场动画 / 导航 / 时间线缩略图入口 / 三特色卡(全部激活)/ 启示滚动栏
- ✅ **交互式时间线**(灵魂):B+C 混合,5 时代 16 节点,三层卡片
- ✅ **M2 理论与争议**(深度):7 段理论页 ×3 + 错误理论博物馆 + 麦克斯韦方程组 KaTeX 拆解
- ✅ **M4 科学家列传**(人文):6 段人物页 ×4 + 被遗忘的先驱
- ✅ **M3 工程应用史**(特色):案例页 ×2(因果链)+「如果没有电磁学」模拟器 island
- ✅ **M5 科学启示录**(价值):5 规律 / 5 建议 / 科学与社会 / 10 个教训
- ⏳ **未完成**:M1 时间线深化、M6 资源中心+创意交互、M7 打磨上线、部署 CI(最后做)
